...
#ifndef HTTP_REQUEST_BASE_H_
#define HTTP_REQUEST_BASE_H_
...
protected:
    virtual nsapi_error_t connect_socket(SocketAddress address) = 0;
...
private:
    nsapi_error_t connect_socket( ) {
        ...
        if (_we_created_socket) {
            ...
            _network->gethostbyname(_parsed_url->host(), &address);
